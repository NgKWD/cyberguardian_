  ...
  return (
    <div className="home-container">
      ...
      <div className="home-header">
        ...
        >
          <span className="home-logo">CYBERGUARDIAN</span>
          ...
          >
            <div className="home-nav">
              <div className="home-top">
                <span className="logo">CYBERSEC</span>
      ...
      <div className="home-pricing">
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <h2 className="heading2">Upcoming Workshops</h2>
          ...
          <div className="home-container05">
            ...
            <div className="basicPricingCard home-pricing-card1">
              <div className="home-container10">
                <span className="home-text41 heading3">BASIC</span>
                <span>
                  In-depth sessions covering all the cybersecurity topics from
                  the Q&amp;A format, including interactive demonstrations and
                  hands-on exercises.
                </span>
              </div>
              <div className="home-container11">
                ...
                <span className="home-basic-plan-pricing">500</span>
                <span className="home-text45">/ per person</span>
              </div>
              <div className="home-container12">
                ...
                <div className="home-container16">
                  ...
                  <span>
                    Exclusive networking event with cybersecurity experts and
                    other early bird attendees.
                  </span>
                </div>
              </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              ...
              <div className="home-container18">
                ...
                <span className="home-pro-plan-pricing">1000</span>
                <span className="home-text57">/ per person</span>
              </div>
              <div className="home-container19">
                ...
                <div className="home-container22">
                  ...
                  <span>
                    Certificate of completion indicating participation in the
                ...
                <div className="home-container24">
                  ...
                  <span>
                    Access to general networking sessions with other attendees
                    and speakers
                  </span>
                </div>
              </div>
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
          <h1 className="home-banner-heading heading2">Have some questions?</h1>
            ...
            <span>
              <span>
                <span>
                  ...
                  employees. Dive into the latest cyber threats, best practices,
                  and real-world examples to fortify your defenses.
                </span>
                <span>
                  <span
                    dangerouslySetInnerHTML={{
          ...
          <button className="buttonFilled">Send message</button>
        </div>
      </div>
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            <div className="home-container25">
              ...
              <h2 className="home-text81 heading2">Common questions</h2>
              <span className="home-text82 bodyLarge">
      ...
      <div className="home-footer">
        <footer className="footerContainer home-footer1">
          <div className="home-container27">
            <span className="home-logo2">cyberguardian</span>
          ...
          <div className="home-container28">
            <span className="bodySmall home-text85">
